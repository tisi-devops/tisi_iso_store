          ...
          <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                <input type="email" name="comp_email" required className="w-full p-4 border border-slate-200 rounded-2xl outline-none" placeholder="อีเมล (สำหรับรับรหัส OTP และรับไฟล์เอกสาร ISO)" />
              </div>
            </div>
          </div>
