...
//       return <div>วันที่ปัจจุบัน: {formattedDate}</div>; // ผลลัพธ์: 12 มีนาคม 2026
//     };
...
//         {/* ครอบด้วย div relative เพื่อให้ Dropdown อ้างอิงตำแหน่งจากปุ่มนี้ */}
//         <div className="relative">
          
//           {/* เปลี่ยน Link เป็น button และใส่ onClick เพื่อสลับค่าเปิด/ปิด */}
//           <button 
...
//               {/* ข้อมูลที่รับมาจากฟอร์ม (แทนที่ด้วยตัวแปร State ของคุณได้เลย) */}
//               <div className="p-4 space-y-3">
//                 {/* ตัวอย่างข้อมูลบรรทัดที่ 1 */}
//                 <div className="flex justify-between text-sm">
//                   <span className="text-slate-500">ชื่อผู้ติดต่อ:</span>
//                   <span className="font-medium text-slate-800">คุณสมชาย ใจดี</span> {/* เอาตัวแปรจากฟอร์มมาใส่ตรงนี้ */}
//                 </div>

//                 {/* ตัวอย่างข้อมูลบรรทัดที่ 2 */}
//                 <div className="flex justify-between text-sm">
//                   <span className="text-slate-500">หน่วยงาน:</span>
//                   <span className="font-medium text-slate-800">บริษัท ทดสอบ จำกัด</span>
//                 </div>

//                 {/* ตัวอย่างข้อมูลบรรทัดที่ 3 */}
//                 <div className="flex justify-between text-sm">
//                   <span className="text-slate-500">มาตรฐานที่ขอ:</span>
//                   <span className="font-medium text-blue-600">ISO 9001:2015</span>
//                 </div>

//                 <div className="border-t border-slate-100 pt-3 mt-3">
//                   <div className="flex justify-between items-center">
//                     <span className="font-bold text-slate-800">ยอดชำระ:</span>
//                     <span className="font-bold text-red-600 text-lg">6,800 THB</span>
//                   </div>
//                 </div>
//               </div>
              
//               {/* ปุ่ม Action ด้านล่าง (ถ้ามี) */}
